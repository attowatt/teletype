...
const tele_op_t *tele_ops[E_OP__LENGTH] = {
    ...
    &op_I2M_C_TCUR, &op_I2M_C_TTILDE, &op_I2M_C_DCUR, &op_I2M_C_DTILDE, 
    &op_I2M_C_B, &op_I2M_NT, &op_I2M_C_POUND,
    ...
    &op_I2M_MUTE_POUND, &op_I2M_SOLO, &op_I2M_SOLO_POUND, 
    &op_I2M_PRESET, &op_I2M_PRE, &op_I2M_SAVE, &op_I2M_TEST,
